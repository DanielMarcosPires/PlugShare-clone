  ...
  return (
    <div className="bs-container">
      ...
      <div className="bs-header-logo">
        ...
        <div className="bs-kia-slogan">EXPERIENCE <span className="bs-kia-light">Movement that inspires</span></div>
      </div>
      ...
      <div className="bs-bottom">
        ...
        <button className="bs-circle" onClick={() => alert('Energia')} aria-label="energia">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path>
          </svg>
        </button>
        <button className="bs-circle" onClick={() => alert('Notificações')} aria-label="notificacoes">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
